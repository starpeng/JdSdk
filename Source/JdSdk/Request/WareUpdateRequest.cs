...
2013-12-21 15:53:18.50539 +08:00
*/
#endregion
...
namespace JdSdk.Request
{
    ...
    public class WareUpdateRequest : JdRequestBase<WareUpdateResponse>
    {
        ...
        /// <summary>
        /// 用户自行输入的属性值,结构:&quot;输入值|输入值2|输入值3图书品类输入值规则：ISBN：数字、字母格式出版时间：日期格式“yyyy-mm-dd”版次：数字格式印刷时间：日期格式“yyyy-mm-dd”印次：数字格式页数：数字格式字数：数字格式套装数量：数字格式附件数量：数字格式
        /// </summary>
