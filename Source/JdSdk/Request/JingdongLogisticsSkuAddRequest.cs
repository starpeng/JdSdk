...
2013-09-07 15:01:53.42862 +08:00
*/
#endregion
...
namespace JdSdk.Request
{
    ...
    public class JingdongLogisticsSkuAddRequest : JdRequestBase<JingdongLogisticsSkuAddResponse>
    {
        ...
        public override void Validate()
        {
            ...
            RequestValidator.ValidateRequired("category_name", this.CategoryName);
            RequestValidator.ValidateRequired("size_definition", this.SizeDefinition);
            ...
            RequestValidator.ValidateRequired("volume", this.Volume);
        }
