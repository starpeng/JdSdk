...
namespace JdSdk
{
    ...
    public class JdDictionary : Dictionary<string, string>
    {
        ...
        public void Add(string key, object value)
        {
            ...
            else if (value is List<JdSdk.Domain.Field>)
            {
                List<JdSdk.Domain.Field> v = value as List<JdSdk.Domain.Field>;
        ...
        private String ParseFieldList(List<JdSdk.Domain.Field> list)
        {
            list.Sort((JdSdk.Domain.Field a, JdSdk.Domain.Field b) => { return String.Compare(a.Key, b.Key); });
            IEnumerator<JdSdk.Domain.Field> enumerator = list.GetEnumerator();
